  ...
  const jobs: Job[] = [
    {
      ...
      description:
        "We are looking for a Senior Full Stack Developer to join our core team. You will be responsible for building scalable web applications and leading a team of junior developers.\n\nRequirements:\n- 5+ years of experience with React and Node.js\n- Strong understanding of system architecture\n- Experience with AWS and DevOps practices",
    ...
    },
    {
      ...
      description:
        "Join us in designing the future of AI-driven recruitment tools. We need a designer who can translate complex data into simple, intuitive user interfaces.",
    ...
    },
    {
      ...
      postedAt: "1 day ago",
      description:
        "Develop high-performance microservices and API infrastructures for our global clients. You will work on massive datasets and high-concurrency systems.",
    ...
    },
    {
      ...
      postedAt: "3 days ago",
      description:
        "Help us build blazing-fast frontend applications using Next.js and Tailwind CSS. Focus on performance and accessibility.",
    ...
    },
    {
      ...
      postedAt: "4 days ago",
      description:
        "Scale our infrastructure to handle millions of requests. Master of Kubernetes, Docker, and CI/CD pipelines.",
    ...
    },
    {
      ...
      postedAt: "1 week ago",
      description:
        "Build cross-platform mobile applications using Flutter. Experience with mobile payments integration is a plus.",
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
          ...
          {/* <div className="flex items-center gap-3 hidden">
            <button
              ...
              className={`p-2 rounded-[10px] transition-all ${viewType === "grid" ? "bg-[#286ef0] text-white shadow-lg shadow-blue-100" : "bg-white text-gray-400 hover:text-[#286ef0] shadow-sm"}`}
            >
              <LayoutGrid className="w-5 h-5" />
            </button>
            <button
              onClick={() => setViewType("list")}
              className={`p-2 rounded-[10px] transition-all ${viewType === "list" ? "bg-[#286ef0] text-white shadow-lg shadow-blue-100" : "bg-white text-gray-400 hover:text-[#286ef0] shadow-sm"}`}
            >
